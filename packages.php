...
<html lang="en">
    ...
    <body>
        ...
        <div class="heading" style="background: url(images/m.jpg) no-repeat">
        ...
        <!--package section starts-->
            <section class="packages">
                ...
                <div class="box-container">
                    ...
                    <div class="box">
                        <div class="image">
                            <img src="images/k.png" alt="red car">
                        </div>
                        <div class="content">
                    ...
                    <div class="box">
                        ...
                        <div class="content">
                            <h3 class="adventure">Buffing only</h3>
                            <a href="book.php" class="btn">book now</a>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="image">
                            <img src="images/footer.jpg" alt="red car">
                        </div>
                        <div class="content">
                            <h3 class="adventure">Buffing and Rim cleaning</h3>
                            <a href="book.php" class="btn">book now</a>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="image">
                            <img src="images/a.png" alt="red car">
                        </div>
                        <div class="content">
                            <h3 class="adventure">Chameleon Tint</h3>
                            <a href="book.php" class="btn">book now</a>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="image">
                            <img src="images/r.png" alt="red car">
                        </div>
                        <div class="content">
                            <h3 class="adventure">Headlights film.</h3>
                            <a href="book.php" class="btn">book now</a>
                        </div>
                    </div>
